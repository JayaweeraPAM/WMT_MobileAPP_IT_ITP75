...
function C(isDark: boolean) {
  return {
    bg:        isDark ? 'linear-gradient(135deg, #020617 0%, #0F172A 100%)' : 'linear-gradient(135deg, #E0F2FE 0%, #F1F5F9 50%, #FAF5FF 100%)',
    bgCard:    isDark ? 'rgba(30, 41, 59, 0.70)'   : 'rgba(255, 255, 255, 0.75)',
    bgSection: isDark ? 'rgba(30, 41, 59, 0.50)'   : 'rgba(224, 242, 254, 0.40)',
    label:     isDark ? 'rgba(255, 255, 255, 0.95)' : '#0F172A',
    secondary: isDark ? 'rgba(241, 245, 249, 0.70)' : 'rgba(15, 23, 42, 0.70)',
    tertiary:  isDark ? 'rgba(241, 245, 249, 0.45)' : 'rgba(15, 23, 42, 0.45)',
    ...
    sep:       isDark ? 'rgba(241, 245, 249, 0.15)' : 'rgba(15, 23, 42, 0.12)',
    sepLight:  isDark ? 'rgba(241, 245, 249, 0.10)' : 'rgba(15, 23, 42, 0.08)',
    cardShadow: isDark ? 'none'
               : '0 4px 12px rgba(0,0,0,0.03), 0 1px 3px rgba(0,0,0,0.02)',
    navBg:     isDark ? 'rgba(15, 23, 42, 0.85)'    : 'rgba(224, 242, 254, 0.85)',
  };
}
...
export function LandingPage() {
  ...
  return (
    <div style={{ background: c.bg, color: c.label, fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Helvetica Neue', 'Inter', sans-serif", minHeight: '100vh', overflowX: 'hidden', zoom: '1.1' }}>
      ...
      {/* ══ HERO ═════════════════════════════════════════════════ */}
      <section style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', paddingTop: 100, paddingBottom: 100, padding: '100px 1.25rem', position: 'relative', overflow: 'hidden' }}>
        {/* Bg blobs */}
        ...
        <div style={{ maxWidth: 1100, margin: '-40px auto 0 auto', width: '100%', position: 'relative', zIndex: 1 }}>
